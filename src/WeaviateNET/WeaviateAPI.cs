...
// Body -> Body<P>
// Decorate with <P> all the methods (and constraint when P : class,new())
// Remove JsonObject object and replace references to JObject
...
namespace WeaviateNET
{
    ...
    public partial class GraphQLResponse
    {
        ...
        public System.Collections.Generic.IDictionary<string, JObject> Data { get; set; }
